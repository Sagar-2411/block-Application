...
public class CategoryController {
	...
	public ResponseEntity <CategoryResponse> getAllCategory(
			...
			@RequestParam(value = "sortDir",defaultValue = "categoryId",required = false) String sortDir
			){
		logger.info("Entering request for the get all category data in controller layer");
		CategoryResponse categories = this.categorySer.getCategories( pageNumber, pageSize);
